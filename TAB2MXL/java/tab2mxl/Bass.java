	...
	{		         
		...
		for (int i = 2 ; s1.charAt(i) != '|' ; i++)
		{
			if (Character.isDigit(s1.charAt(i))) {
				//Prints out info about the note in string 1 (can be deleted later):
				...
				System.out.println("\t\t<step>" +  Notes.bassNotes("note1",Character.getNumericValue(s1.charAt(i))) + "</step>");
				System.out.println("\t\t</pitch>");
			...
			if (Character.isDigit(s2.charAt(i))) {
				//Prints out info about the note in string 2 (can be deleted later):
				...
				System.out.println("<note>");
				System.out.println("\t<pitch>");
				System.out.println("\t\t<step>" + Notes.bassNotes("note2",Character.getNumericValue(s2.charAt(i))) + "</step>");
				System.out.println("\t\t</pitch>");
				System.out.println("\t<notations>");
				System.out.println("\t\t<technical>");
			...
			if (Character.isDigit(s3.charAt(i))) {
				//Prints out info about the note in string 3 (can be deleted later):
				...
				System.out.println("<note>");
				System.out.println("\t<pitch>");
				System.out.println("\t\t<step>" + Notes.bassNotes("note3",Character.getNumericValue(s3.charAt(i))) + "</step>");
				System.out.println("\t\t</pitch>");
				System.out.println("\t<notations>");
				System.out.println("\t\t<technical>");
			...
			if (Character.isDigit(s4.charAt(i))) {
				//Prints out info about the note in string 4 (can be deleted later):
				...
				System.out.println("<note>");
				System.out.println("\t<pitch>");
				System.out.println("\t\t<step>" + Notes.bassNotes("note4",Character.getNumericValue(s4.charAt(i))) + "</step>");
				System.out.println("\t\t</pitch>");
				System.out.println("\t<notations>");
				System.out.println("\t\t<technical>");
			...
			if (s5 != null && Character.isDigit(s5.charAt(i))) {
				//Prints out info about the note in string 5 (can be deleted later):
				...
				System.out.println("<note>");
				System.out.println("\t<pitch>");
				System.out.println("\t\t<step>" + Notes.bassNotes("note5",Character.getNumericValue(s5.charAt(i))) + "</step>");
				System.out.println("\t\t</pitch>");
				System.out.println("\t<notations>");
				System.out.println("\t\t<technical>");
